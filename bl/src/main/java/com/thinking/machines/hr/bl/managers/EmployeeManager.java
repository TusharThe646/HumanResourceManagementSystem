...
this.employeesSet=new TreeSet<>(Comparator.comparing(e -> e.getDesignation().getCode()));//done
...
employee.setDateOfBirth((Date)dlEmployee.getDateOfBirth().clone());//done  done 
...
if(ets==null)
{
ets=new TreeSet<>(Comparator.comparing(e -> e.getName()));//done 
ets.add(employee);
...
{
blException.addException("deignation","Invalid Designation");
}
}
if(dateOfBirth==null)
{
...
dlEmployee.setDateOfBirth((Date)dateOfBirth.clone());//done done 
...
dsEmployee.setAadharCardNumber(aadharCardNumber);//from this 
// Print and add to employeesSet
        System.out.println("Adding employee to employeesSet: " + dsEmployee.getEmployeeId());
        employeesSet.add(dsEmployee);
        System.out.println("Employee added to employeesSet: " + dsEmployee.getEmployeeId());

        // Print and add to employeeIdWiseEmployeesMap
        System.out.println("Adding employee to employeeIdWiseEmployeesMap: " + dsEmployee.getEmployeeId());
        employeeIdWiseEmployeesMap.put(dsEmployee.getEmployeeId().toUpperCase(), dsEmployee);
        System.out.println("Employee added to employeeIdWiseEmployeesMap: " + dsEmployee.getEmployeeId());

        // Print and add to panNumberWiseEmployeesMap
        System.out.println("Adding employee to panNumberWiseEmployeesMap: " + dsEmployee.getPANNumber());
        panNumberWiseEmployeesMap.put(dsEmployee.getPANNumber().toUpperCase(), dsEmployee);
        System.out.println("Employee added to panNumberWiseEmployeesMap: " + dsEmployee.getPANNumber());

        // Print and add to aadharCardNumberWiseEmployeesMap
        System.out.println("Adding employee to aadharCardNumberWiseEmployeesMap: " + dsEmployee.getAadharCardNumber());
        aadharCardNumberWiseEmployeesMap.put(dsEmployee.getAadharCardNumber().toUpperCase(), dsEmployee);
        System.out.println("Employee added to aadharCardNumberWiseEmployeesMap: " + dsEmployee.getAadharCardNumber());

        // Print and add to designationCodeWiseEmployeesMap
        System.out.println("Adding employee to designationCodeWiseEmployeesMap: " + dsEmployee.getDesignation().getCode());

employeesSet.add(dsEmployee);//to this 
employeeIdWiseEmployeesMap.put(dsEmployee.getEmployeeId().toUpperCase(),dsEmployee);
...
{
blException.addException("employeeId"," Invalid employeee Id. "+ employeeId);
}
}
}
