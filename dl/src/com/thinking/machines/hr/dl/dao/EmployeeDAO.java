...
if(aadharCardNumber.length()==0) throw new DAOException("Length if Aadhar Card Number is zero");
try
{
...
if(employeeId==null) throw new DAOException("Employee id id null");
if(employeeId.length()==0) throw new DAOException("Length of employee Id is zero ");
String name=employeeDTO.getName();
if(name==null) throw new DAOException("Name id null");
name=name.trim();
if(name.length()==0) throw new DAOException("Length of name is zero");
int designationCode=employeeDTO.getDesignationCode();
if(designationCode<=0) throw new DAOException("Invalid designation code : "+designationCode);
...
{
randomAccessFile.close();
throw new DAOException("PAN Number ("+panNumber+") and Aadhar car number ("+aadharCardNumber+") exists");
}
...
if(employeeId.length()==0) throw new DAOException("Length os employee Id. is zero");
try
{
...
{
if(aadharCardNumber==null) throw new DAOException("Invalid Aadhar Number : "+aadharCardNumber);
