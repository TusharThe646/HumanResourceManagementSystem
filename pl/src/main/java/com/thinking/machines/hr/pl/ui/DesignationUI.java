...
addIcon=new ImageIcon("c:"+File.separator+"javaProjects"+File.separator+"hr"+File.separator+"icon"+File.separator+"add_icon.png");
editIcon=new ImageIcon("c:"+File.separator+"javaProjects"+File.separator+"hr"+File.separator+"icon"+File.separator+"edit_icon.png");
deleteIcon=new ImageIcon("c:"+File.separator+"javaProjects"+File.separator+"hr"+File.separator+"icon"+File.separator+"delete_icon.png");
pdfIcon=new ImageIcon("c:"+File.separator+"javaProjects"+File.separator+"hr"+File.separator+"icon"+File.separator+"pdf_icon.png");
cancelIcon=new ImageIcon("c:"+File.separator+"javaProjects"+File.separator+"hr"+File.separator+"icon"+File.separator+"cancel_icon.png");
saveIcon=new ImageIcon("c:"+File.separator+"javaProjects"+File.separator+"hr"+File.separator+"icon"+File.separator+"save_icon.png");
